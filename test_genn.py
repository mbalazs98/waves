...
input_pop = model.add_neuron_population("Input", input_num, "Poisson", poisson_params, poisson_init)
...
InputE_syn_pop = model.add_synapse_population("InputE", "SPARSE",
    input_pop, exc_pop,
    init_weight_update("StaticPulseConstantWeight", {"g": 0.5}),
    init_postsynaptic("ExpCurr", {"tau": 5.0}),
    init_sparse_connectivity("FixedProbability", {"prob": 100/exc_num*exc_ratio}))

InputI_syn_pop = model.add_synapse_population("InputI", "SPARSE",
    input_pop, inh_pop,
    init_weight_update("StaticPulseConstantWeight", {"g": 0.5}),
    init_postsynaptic("ExpCurr", {"tau": 5.0}),
    init_sparse_connectivity("FixedProbability", {"prob": 100/inh_num*inh_ratio}))
...
EE_syn_pop = model.add_synapse_population("EE", "SPARSE",
    ...
    #init_sparse_connectivity("FixedNumberPostWithReplacement", {"num": K*exc_ratio}))
...
EI_syn_pop = model.add_synapse_population("EI", "SPARSE",
    ...
    #init_sparse_connectivity("FixedNumberPostWithReplacement",{"num": K*inh_ratio}))
